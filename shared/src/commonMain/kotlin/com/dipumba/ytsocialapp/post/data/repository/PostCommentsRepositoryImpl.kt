        ...
        return withContext(dispatcherProvider.io) {
            try {
                ...
                val apiResponse = postCommentsApiService.addComment(
                    ...
                    userToken = currentUserData.token // TODO: Can't we have these made at service level?
                )
    ...
    override suspend fun removeComment(postId: Long, commentId: Long): Result<PostComment?> {
        return withContext(dispatcherProvider.io) {
            try {
                ...
                if (apiResponse.code == HttpStatusCode.OK) {
                    // Why comment? is nullable below?
                    //  If the comment was removed, the API returns a null comment
                    //  If the comment was not removed, the API returns the remove attempted comment
